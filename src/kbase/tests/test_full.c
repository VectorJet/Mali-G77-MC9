...
int submit_one(int fd, uint32_t core_req, int index) {
    ...
    *marker = 0xABCD0000 | index;
    ...
    /* SHOW FULL VALUE - don't mask! */
    printf("Submit %d: ret=%d, marker was 0x%08x, now 0x%08x (FULL, NOT MASKED)\n", 
           index, ret, 0xABCD0000 | index, *marker);
...
int main(void) {
    ...
    printf("=== Test multi - SHOW FULL VALUES ===\n");
