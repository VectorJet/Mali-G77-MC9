...
int main(void) {
    printf("=== 3 atoms with dep_type=2 ===\n");
    ...
    *(uint32_t*)((uint8_t*)cpu + 0x600) = 1;
    ...
    atoms[1].pre_dep_atom[0] = 0; atoms[1].pre_dep_type[0] = 2;
    atoms[2].jc = gva + 0x400; atoms[2].core_req = 0x004; atoms[2].atom_number = 3;
    atoms[2].pre_dep_atom[0] = 1; atoms[2].pre_dep_type[0] = 2;

    printf("Submitting 3 atoms (dep_type=2)...\n");
