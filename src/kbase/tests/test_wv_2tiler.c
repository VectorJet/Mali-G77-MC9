...
int main(void) {
    ...
    *target = 0xDEADBEEF;
    ...
    job2[4] = (4 << 1) | (1 << 16);
    job2[8] = (uint32_t)(gva + 0x600);
    job2[12] = 0;

    volatile uint32_t *poly0 = (volatile uint32_t *)((uint8_t*)cpu + 0x400);
    *poly0 = 1;
    volatile uint32_t *poly1 = (volatile uint32_t *)((uint8_t*)cpu + 0x600);
    *poly1 = 1;

    printf("WV at 0x%llx, T0 at 0x%llx, T1 at 0x%llx\n", gva, gva+0x200, gva+0x400);
