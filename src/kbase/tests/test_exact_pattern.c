...
int main(void) {
    printf("=== Test 7: Full Pipeline - Exact Working Pattern ===\n\n");
    ...
    /* Color buffer at 0x30 - EXACTLY like working test */
    volatile uint32_t *color = (volatile uint32_t *)((uint8_t*)cpu + 0x30);
    *color = 0xDEADBEEF;

    /* Job 1: WRITE_VALUE - init polygon list */
    ...
    /* Job 4: FRAGMENT - exact pattern like working test */
