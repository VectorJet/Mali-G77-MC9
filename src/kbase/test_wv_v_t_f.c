...
int main(void) {
    printf("=== 4-Atom: WV->V->T->F (Separate Buffers) ===\n\n");
    ...
    *color = 0xDEADBEEF;
    ...
    job_wv[4] = (2 << 1) | (1 << 16);
    job_wv[8] = (uint32_t)(gva_t + 0x100);  /* poly list area */
    ...
    *poly = 0x00000001;
    ...
    printf("WV(0x%lx) -> V(0x%lx) -> T(0x%lx) -> F(0x%lx)\n",
           gva_wv, gva_v, gva_t, gva_f);
