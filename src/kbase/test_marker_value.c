...
int main(void) {
    ...
    printf("=== Use marker value 0xABCD0000 like test_multi ===\n");
    ...
    /* Same initial value as test_multi */
    volatile uint32_t *marker = (volatile uint32_t *)((char*)cpu + 0x100);
    *marker = 0xABCD0000;  /* Same as test_multi! */
    ...
    printf("marker was 0xABCD0000, now 0x%08x\n", *marker);
