...
int main(void) {
    ...
    printf("=== All same initial value, different expected writes ===\n");
    printf("If GPU works: marker should change to 0x1111000X each time\n\n");
    
    /* All use SAME initial value */
    for (int i = 0; i < 5; i++) {
        ...
        job[9] = 0;
        job[10] = 6;
        job[12] = 0x11110000 | i;  /* Different value to write */
        
        /* SAME initial value for all */
        ...
        *marker = 0xABCD0000;  /* Same for all! */
        ...
        printf("Submit %d: initial=0xABCD0000, after=0x%08x, expected=0x%08x - %s\n", 
               i, *marker, 0x11110000 | i,
               (*marker == (0x11110000 | i)) ? "GPU WROTE!" : "NO CHANGE");
