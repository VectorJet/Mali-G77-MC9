...
/*
 * Test: Single job at offset 0x100 (not 0)
 */
int main(void) {
    printf("=== Test: Job at offset 0x100 (no chain) ===\n\n");
    ...
    *t1 = 0xAAAAAAAA;
    ...
    j1[10] = 6;
    j1[12] = 0x11111111;
    /* DON'T set next_job_ptr - let it be implicit end */

    printf("Job at 0x%llx -> target 0x%llx\n", 
    ...
    printf("\nResult: 0x%08x (expected 0x11111111)\n", *t1);
    if (*t1 == 0x11111111) printf("SUCCESS!\n");
    else printf("FAIL\n");
