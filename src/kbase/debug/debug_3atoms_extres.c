...
int main(void) {
    printf("=== Debug: 3 atoms with EXTRES like Chrome ===\n");
    ...
    *(uint32_t*)((uint8_t*)cpu + 0x600) = 1;
    ...
    /* 3 atoms with EXTRES and proper udata like Chrome */
    ...
    atoms[0].seq_nr = 0;
    atoms[0].nr_extres = 0;
    atoms[0].extres_list = 0;
    /* Chrome uses udata for completion notifications */
    atoms[0].udata[0] = gva + 0x100;  /* completion address */
    atoms[0].udata[1] = 0;
    ...
    printf("Submitting 3 atoms with extres...\n");
