...
struct VkPhysicalDeviceMemoryProperties {
    ...
    struct VkMemoryHeap memoryHeaps[16];
};
...
struct VkFormatProperties2 {
    uint32_t sType;
    void *pNext;
    struct VkFormatProperties formatProperties;
};

struct VkImageFormatProperties {
    struct VkExtent3D maxExtent;
...
struct VkImageFormatProperties2 {
    uint32_t sType;
    void *pNext;
    struct VkImageFormatProperties imageFormatProperties;
};
...
struct VkSurfaceFormat2KHR {
    uint32_t sType;
    void *pNext;
    struct VkSurfaceFormatKHR surfaceFormat;
};
