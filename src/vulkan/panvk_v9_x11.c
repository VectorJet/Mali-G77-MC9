 ...
 * Renders on ARM Mali-G77 MC9 (/dev/mali0) and displays frame on DISPLAY=:0
 */
...
int main(int argc, char **argv) {
    ...
    XStoreName(dpy, win, "PanVK Mali-G77 Vulkan Driver (Valhall v9)");
    ...
    struct VkRenderPassBeginInfo rpInfo = {
        ...
        .renderAreaExtent = { .width = width, .height = height },
    ...
    printf("SUCCESS: Hardware execution on Mali-G77 completed!\n");
